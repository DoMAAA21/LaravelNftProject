...
@section('body') --}}
    ...
    <div class="container">
        ...
        <table id="trdtable" class="table table-striped table-hover" style="width:100%;">
            <thead>
                <tr>
                    <th>Id</th>
                    <th>Crypto</th>
...
<div class="modal" id="trdModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width:75%;">
      <div class="modal-content">
<div class="modal-header text-center">
  

           <h3 class="modal-title" id="tcreate">Create Crypto</h3> 
            <h3 class="modal-title" id="tupdate">Sell Crypto</h4> 
         </div> 
     
 <form id="trdform" action="#" method="#" enctype="multipart/form-data">
...
<div class="modal-footer d-flex justify-content-center">
                   ...
                   <button id="trdSubmit" type="submit" class="btn btn-primary">Save</button>
                     <button id="trdpupdate" type="submit" class="btn btn-primary">Trade</button>
